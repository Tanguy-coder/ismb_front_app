...
export class AppSidebarComponent {
  ...
  navItems: NavItem[] = [
    ...
    },
    {
      ...
      subItems: [
        { name: "Etablissement", path: "/etablissement" },
        { name: "Année Scolaire", path: "/annee" },
        { name: "Niveaux", path: "/niveau" },
        { name: "Filières", path: "/filiere" },
        { name: "Matières", path: "/matieres" },
        { name: "Unités d'Ens.", path: "/ues" },
      ],
    },
    {
      name: "Scolarité",
      ...
      subItems: [
        ...
        { name: "Notes & Evaluations", path: "/notes" },
      ],
    },
    {
      name: "Administration",
